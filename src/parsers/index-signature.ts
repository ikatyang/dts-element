...
import {create_index_signature, IIndexSignature} from '../others/index-signature';
import {parse_native} from '../parse';
import {has_kind, if_defined} from '../utils';

export const parse_index_signature = (node: ts.IndexSignatureDeclaration): IIndexSignature =>
