...
import {
  ...
  IGlobalDeclaration,
} from '../declarations/global-declaration';
import {
  create_module_declaration,
  IModuleDeclaration,
} from '../declarations/module-declaration';
import {
  create_namespace_declaration,
  INamespaceDeclaration,
} from '../declarations/namespace-declaration';
...
): INamespaceDeclaration | IGlobalDeclaration | IModuleDeclaration => {
