...
const normalize_generics = (generics: Type[], is_definition: boolean): (Type | GenericDefinition)[] =>
  generics.map((generic: Type) =>
    !(generic instanceof GenericType) || !is_definition
      ? generic
