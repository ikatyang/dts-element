...
it('should return empty string while stack is not GenericType-GenericDefinition or EnumMember', () => {
...
it('should return emitted type while value is Type and last stack is GenericType-GenericDefinition', () => {
  expect(emit_equal(basic_type, new Stack([generic_definition, generic_type]))).toMatchSnapshot();
});
