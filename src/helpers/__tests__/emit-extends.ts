...
it('should return extends with emitted type while extends is not null and stack is GenericDefinition', () => {
  expect(emit_extends(basic_type, new Stack([generic_definition]))).toMatchSnapshot();
});
