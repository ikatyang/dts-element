...
export interface IIndexSignature
  extends IElement<ElementKind.IndexSignature>,
    IIndexSignatureOptions {}

export const create_index_signature = (
  options: IIndexSignatureOptions,
): IIndexSignature => ({
 ...
 * @hidden
 */
export const transform_index_signature = (
  element: IIndexSignature,
  path: IElement<any>[],
) =>
  ts.createIndexSignature(
    ...
    /* modifiers   */ element.readonly === true
      ...
      : undefined,
    /* parameters  */ [
      transform(element.parameter, path) as ts.ParameterDeclaration,
    ],
