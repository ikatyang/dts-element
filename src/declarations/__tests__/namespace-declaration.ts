...
describe('is_namespace_declaration', () => {
  it('should return correctly', () => {
    const element = create_namespace_declaration({
      name: 'N',
    });
    expect(is_namespace_declaration(element)).toBe(true);
  });
});
