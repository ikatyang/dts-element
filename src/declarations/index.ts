...
export {IClassDeclaration, IClassDeclarationOptions, create_class_declaration} from './class-declaration';
...
export {IParameterDeclaration, IParameterDeclarationOptions, create_parameter_declaration} from './parameter-declaration';
export {ITypeDeclaration, ITypeDeclarationOptions, create_type_declaration} from './type-declaration';
export {IVariableDeclaration, IVariableDeclarationOptions, create_variable_declaration} from './variable-declaration';
