...
export interface IParameterDeclaration
  extends IElement<ElementKind.ParameterDeclaration>,
    IParameterDeclarationOptions {}

export const create_parameter_declaration = (
  options: IParameterDeclarationOptions,
): IParameterDeclaration => ({
  ...create_element(ElementKind.ParameterDeclaration),
  ...options,
});

export const is_parameter_declaration = (
  value: any,
): value is IParameterDeclaration =>
  is_element(value) && value.kind === ElementKind.ParameterDeclaration;
 ...
 * @hidden
 */
export const transform_parameter_declaration = (
  element: IParameterDeclaration,
  path: IElement<any>[],
) =>
  ts.createParameter(
