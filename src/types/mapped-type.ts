...
export interface IMappedType
  extends IElement<ElementKind.MappedType>, IMappedTypeOptions {}

export const create_mapped_type = (options: IMappedTypeOptions): IMappedType => ({
...
export const transform_mapped_type = (element: IMappedType, path: IElement<any>[]) => {
  ...
  return ts.createMappedTypeNode(
    /* readonlyToken */ (element.readonly === true)
                          ...
                          : undefined,
    /* typeParameter */ transform(element.parameter, path) as ts.TypeParameterDeclaration,
