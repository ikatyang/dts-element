...
export interface IFunctionType
  extends IElement<ElementKind.FunctionType>,
    IFunctionTypeOptions {}

export const create_function_type = (
 ...
 * @hidden
 */
export const transform_function_type = (
  element: IFunctionType,
  path: IElement<any>[],
) =>
